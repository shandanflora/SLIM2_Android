 ...
 *
 */
public class TestIntlTranslate_Fake_Portuguese {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("Portuguese");
        //only for debug
    ...
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("Italian"));
        driver.quit();
    }
