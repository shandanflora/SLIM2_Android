 ...
 *
 */
public class TestIntlTranslate_Fake_LA_Portuguese {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("LA-Portuguese");
        //only for debug
    ...
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("Hebrew"));
        driver.quit();
    }
