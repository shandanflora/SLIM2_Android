 ...
 */
public class TestIntlTranslate_Malay {
    ...
    public void setUp(){
        ...
        HandleDM80i.getInstance().translate_init("Malay", "Malay");
        //HandleDM80i.getInstance().translateErrorReport_init();
    }

    @AfterClass
    public void tearDown(){
        HandleDM80i.getInstance().changeLanguage(PropertyData.getProperty("Korean"));
        driver.quit();
    }
