 ...
 *
 */
public class TestIntlTranslate_Fake_fr_CA {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("fr-CA");
        //HandleFake.getInstance().translateErrorReport_init();
    }

    @AfterClass
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("Japanese"));
        driver.quit();
    }
