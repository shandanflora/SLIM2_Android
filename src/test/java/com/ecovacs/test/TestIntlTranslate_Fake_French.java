 ...
 *
 */
public class TestIntlTranslate_Fake_French {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("French");
        //only for debug
    ...
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("Portuguese"));
        driver.quit();
    }
