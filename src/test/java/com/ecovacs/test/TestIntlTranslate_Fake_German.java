 ...
 *
 */
public class TestIntlTranslate_Fake_German {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("German");
        //only for debug
    ...
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("Spanish"));
        driver.quit();
    }
