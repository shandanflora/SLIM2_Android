 ...
 *
 */
public class TestIntlTranslate_Fake_Thai {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("Thai");
        //HandleFake.getInstance().translateErrorReport_init();
    }

    @AfterClass
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("LA_Portuguese"));
        driver.quit();
    }
