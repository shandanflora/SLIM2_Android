 ...
 *
 */
public class TestIntlTranslate_Fake_Hebrew {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("Hebrew");
        //HandleFake.getInstance().translateErrorReport_init();
    }

    @AfterClass
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("Ukrainian"));
        driver.quit();
    }
