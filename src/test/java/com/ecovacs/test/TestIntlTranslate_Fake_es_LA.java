 ...
 *
 */
public class TestIntlTranslate_Fake_es_LA {
    ...
    public void setUp(){
        ...
        HandleFake.getInstance().translate_init("es-LA");
        HandleFake.getInstance().translateErrorReport_init();
    }

    @AfterClass
    public void tearDown(){
        HandleFake.getInstance().changeLanguage(PropertyData.getProperty("fr-CA"));
        driver.quit();
    }
