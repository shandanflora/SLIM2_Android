...
public class MoreActivity {
    ...
    private AndroidElement textHelp = null;
    @FindBy(xpath = "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[5]/android.widget.RelativeLayout[1]/android.widget.TextView[1]")
    ...
    private boolean staticUiTranslation(Map<String, String> tranMap){
        ...
        boolean btextHelp = textHelp.getText().equalsIgnoreCase(tranMap.get("setting_help_center"));
        if(!btextHelp){
            TranslateErrorReport.getInstance().insetNewLine(
                    strLanguage, "More", textHelp.getText(),
